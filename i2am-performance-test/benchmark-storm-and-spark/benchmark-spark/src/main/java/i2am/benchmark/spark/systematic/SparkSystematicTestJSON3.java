...
public class SparkSystematicTestJSON3 {	

	private final static Logger logger = Logger.getLogger(SparkSystematicTestJSON3.class);
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		JedisCluster paramter = new JedisCluster(redisNodes);	
		...
		// Sampling Parameters.
		int sample_size = Integer.parseInt(paramter.get("SampleSize"));
		int window_size = Integer.parseInt(paramter.get("WindowSize"));
		String redis_key = paramter.get("SampleKey");
		
		paramter.ltrim(redis_key, 0, -99999);
