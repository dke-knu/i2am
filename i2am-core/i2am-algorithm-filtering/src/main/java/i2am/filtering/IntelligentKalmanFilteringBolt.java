...
/**
 * Created by sbpark on 2018-07-23.
 */
public class IntelligentKalmanFilteringBolt extends BaseRichBolt {
    ...
    /* Logger */
    private final static Logger logger = LoggerFactory.getLogger(IntelligentKalmanFilteringBolt.class);

    public IntelligentKalmanFilteringBolt(String redisKey, JedisClusterConfig jedisClusterConfig){
