...
public class PrioritySampling extends Algorithm {
	private int sampleSize;
	private int windowSize;
	
	public PrioritySampling(int idx, int sampleSize, int windowSize) {
		super(idx);
		super.type = ALGORITHM_TYPE.PRIORITY_SAMPLING;
