...
public class BinaryBernoulliSampling extends Algorithm {
	private int sampleSize;
	private int windowSize;
	
	public BinaryBernoulliSampling(int idx, int sampleSize, int windowSize) {
		super(idx);
		super.type = ALGORITHM_TYPE.BINARY_BERNOULLI_SAMPLING;
