...
<body>
		...
		<div class="outer">
			<form id="form-login" name="form-login" action="ajax/login-ok.jsp" method="post">				
				...
				<div>					
					...
					<input type="text" placeholder="Enter Username" name="user-login-id" id="user-login-id" required>
					<label for="password"><b>Password</b></label>
					<input type="password" placeholder="Enter Password" name="user-login-pw" id="user-login-pw" required>
	...
	<div id="id01" class="modal">
    	...
    	<div class="container">
      		...
      		<input type="text" placeholder="Enter Email" name="email" id="user-join-id" required>

			<label for="name"><b>name</b></label>
      		<input type="text" placeholder="Enter Full Name" name="name" id="user-join-name" required>

      		<label for="psw"><b>Password</b></label>
      		<input type="password" placeholder="Enter Password" name="psw" id="user-join-pw" required>

      		<label for="psw-repeat"><b>Repeat Password</b></label>
      		<input type="password" placeholder="Repeat Password" name="psw-repeat" id="user-join-pw-rp" required>
