...
public class Msg {
	...
	private EventQueueHandler.Eventable clientSession;
	...
	void setClientSession(EventQueueHandler.Eventable clientSession) {
		this.clientSession = clientSession;
	}

	EventQueueHandler.Eventable getClientSession() {
