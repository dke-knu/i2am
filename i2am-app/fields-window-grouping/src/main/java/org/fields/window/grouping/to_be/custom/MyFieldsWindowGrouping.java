...
public class MyFieldsWindowGrouping implements CustomStreamGrouping, Serializable {
    ...
    public MyFieldsWindowGrouping() {
        //Empty
    }

    public MyFieldsWindowGrouping(Fields fields) {
        this.fields = fields;
    }
