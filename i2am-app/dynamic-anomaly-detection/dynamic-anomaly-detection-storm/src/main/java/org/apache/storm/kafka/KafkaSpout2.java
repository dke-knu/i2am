...
public class KafkaSpout2 extends BaseRichSpout {
    ...
    public KafkaSpout2(SpoutConfig spoutConf, String str) {
    ...
    public void nextTuple() {
    	System.out.println("NEXTTUPLE ssw");
    	LOG.error("NEXTTUPLE ssw2");
        ...
        for (int i = 0; i < managers.size(); i++) {
            ...
            try {
                ...
                org.apache.storm.kafka.KafkaSpout.EmitState state = managers.get(_currPartitionIndex).next(_collector);
                if (state != org.apache.storm.kafka.KafkaSpout.EmitState.EMITTED_MORE_LEFT) {
                    _currPartitionIndex = (_currPartitionIndex + 1) % managers.size();
                }
                if (state != org.apache.storm.kafka.KafkaSpout.EmitState.NO_EMITTED) {
                    break;
                }
