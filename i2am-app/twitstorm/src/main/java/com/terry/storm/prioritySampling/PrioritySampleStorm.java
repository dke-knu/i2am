...
public class PrioritySampleStorm {
   ...
   public static void main(String[] args) throws Exception{
      ...
      builder.setBolt("twitter-hashtag-reader-bolt", new HashtagReaderBolt(), 4)
         .shuffleGrouping("twitter-spout");
      
      builder.setBolt("priority-sample-bolt", new PrioritySampleBolt(size_of_sample, window_size, db_ip, port), 4)
      .fieldsGrouping("twitter-hashtag-reader-bolt", new Fields("hashtag"));
			      
      
      if( mode.equals("0") ) {
    	  LocalCluster cluster = new LocalCluster();
          cluster.submitTopology("PrioritySampleTopology", config, builder.createTopology());
          Thread.sleep(100000);
          cluster.shutdown();
      } else {
    	  StormSubmitter.submitTopology("PrioritySampleTopology", config, builder.createTopology());
      }
