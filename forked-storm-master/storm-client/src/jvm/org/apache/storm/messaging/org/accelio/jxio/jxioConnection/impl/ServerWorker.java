 ...
 **
 */
package org.apache.storm.messaging.org.accelio.jxio.jxioConnection.impl;
...
public class ServerWorker extends Thread implements BufferSupplier, WorkerCache.Worker {
	...
	private final Callbacks appCallbacks;
...
//	 * @param sk
	...
	private static class OSWorker implements StreamWorker {
		...
		private JxioConnectionServer.Callbacks appCallbacks;

		public OSWorker(ServerWorker worker, JxioConnectionServer.Callbacks appCallbacks) {
			this.worker = worker;
			this.appCallbacks = appCallbacks;
		}
